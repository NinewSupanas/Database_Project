...
const LoginRegister = ({ onLogin }) => {
  ...
  const handleLogin = async (event) => {
    ...
    try {
      const response = await fetch('https://database-project-1-qu6h.onrender.com/login', {
        method: 'POST',
        headers: {
  ...
  const handleRegister = async (event) => {
    ...
    try {
      const response = await fetch('https://database-project-1-qu6h.onrender.com/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
